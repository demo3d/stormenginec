...
StormRender = function(width, height) {
	...
	e.id = 'DIVID_stormCanvas2D';
	e.style.width = this.viewportWidth+'px';
	e.style.position = 'absolute';
	e.style.display = 'block';
	e.innerHTML= '<canvas id="stormCanvas2D" style="border: 1px solid #0000FF;" width="'+this.viewportWidth+'" height="'+this.viewportHeight+'"></canvas>';
...
StormRender.prototype.makeRender = function(nodeCam) {
	document.getElementById("DIVID_stormCanvas2D").style.display = "block";
    ...
    else document.getElementById("DIVID_stormCanvas2D").style.display="none";
