...
StormJigLibJS.prototype.update = function(elapsed) {
	...
	for(var n = 0; n < this.nodes.length; n++) {
		...
		if(this.nodes[n].car != undefined) {
			...
			this.nodes[n].ndWheelFL.setRotation(stormEngineC.utils.degToRad(this.nodes[n].wheelFL.getSteerAngle()), $V3([0.0, 1.0, 0.0]));
			...
			this.nodes[n].ndWheelFR.setRotation(stormEngineC.utils.degToRad(this.nodes[n].wheelFR.getSteerAngle()), $V3([0.0, 1.0, 0.0]));
			...
			this.nodes[n].ndWheelBL.setRotation(stormEngineC.utils.degToRad(this.nodes[n].wheelBL.getSteerAngle()), $V3([0.0, 1.0, 0.0]));
			...
			this.nodes[n].ndWheelBR.setRotation(stormEngineC.utils.degToRad(this.nodes[n].wheelBR.getSteerAngle()), $V3([0.0, 1.0, 0.0]));
